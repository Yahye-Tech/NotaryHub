...
import BranchQueueOperations from "./branch/BranchQueueOperations";
import BranchAppointmentsTab from "./branch/BranchAppointmentsTab";
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 items-start">
        ...
        <div className="md:col-span-3 space-y-6">
          ...
          {activeTab === "appointments" && (
            <BranchAppointmentsTab
              localApps={localApps}
              localEmployees={localEmployees}
              calendarScope={calendarScope}
              setCalendarScope={setCalendarScope}
              handleCancelApp={handleCancelApp}
              triggerReassignApp={triggerReassignApp}
              reassignAppTarget={reassignAppTarget}
              reassignTargetEmp={reassignTargetEmp}
              setReassignTargetEmp={setReassignTargetEmp}
              executeReassignApp={executeReassignApp}
              setReassignAppTarget={setReassignAppTarget}
            />
          )}
